...
CPPFLAGS = -I. -I./header_files
CFLAGS =-g -std=gnu99 -O1 -Wall
CXXFLAGS = -g -std=gnu++11 -O1 -Wall
LDFLAGS = -lrt -lpthread

SOURCES = golf_main.c golf_global.c golf_lib.c golf_gameplay.c golf_assets.c golf_imagebmp.c 
SOURCES += golf_scene_title.c golf_scene_game.c golf_scene_pause.c golf_scene_end.c golf_scene_loading.c
SOURCES += golf_input.c golf_led.c golf_lcd.c golf_lcd_print.c golf_lcd_load.c

SOURCES += mzapo_phys.c mzapo_parlcd.c
